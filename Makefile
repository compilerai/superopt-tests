...
$(call add_suite,all,           TSVC_prior_work TSVC_new LORE_mem_write LORE_no_mem_write micro bzip2_locals localmem-tests TSVC_prior_work_locals TSVC_prior_work_globals statistical)
