...
$(call add_suite,all,           c2c bzip2 micro localmem-tests TSVC_prior_work TSVC_new LORE_mem_write LORE_no_mem_write TSVC_prior_work_locals TSVC_prior_work_globals statistical)
